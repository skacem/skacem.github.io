...
```
<div class="imgcap">
<img src="/assets/3/rug.png" style="zoom:85%;" alt="swarm plot in a boxplot"/>
</div>
...
So that your only concern is to understand the various elements of your plots, rather than wasting  time on the technicalities of generating them.
