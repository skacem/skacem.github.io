...
```
<div class="imgcap">
<img src="/assets/3/reg1.png" style="zoom:85%;" alt="mpg dataset. Linear regression fuel vs horsepower"/>
</div>
It is also possible to change the order of `regplot()` to model simple kinds of nonlinear relationship between the variables.
```python
sns.regplot(data=mpg, x='horsepower', y='mpg', order=2);
```
<div class="imgcap">
<img src="/assets/3/reg2.png" style="zoom:85%;" alt="mpg dataset. Linear regression second order fuel vs horsepower"/>
</div>
