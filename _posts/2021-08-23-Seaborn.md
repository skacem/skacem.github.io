...
If you want more insight about the missing data you have, consider installing the `missingno` library. It does just that and works on top of seaborn and matplotlib.
### Histograms
...
## Exploring Seaborn’s Less Common Types of Plots
