...
In the above sections we discussed some of the common types of visualitzations such as bar plots, scatter plots, etc. We also introduced the concept of axes-level functions and figure-level functions, we, however, only 
