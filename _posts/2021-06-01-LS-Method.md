...
Nun ist die Pseudoinverse von A durch (3) definiert.
...
## Quellen
1. [Proofs involving the Moore–Penrose inverse](https://en.wikipedia.org/wiki/Proofs_involving_the_Moore%E2%80%93Penrose_inverse).  
2. Stephen M. Kogon Dimitris G. Manolakis, Vinay K. Ingle. "Statistical and adaptive signal processing". Artech house, 2005.  
